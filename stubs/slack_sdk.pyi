...
class WebClient:
    ...
    def chat_postMessage(self, channel: str, text: str = ..., blocks: list[dict[str, Any]] = ...) -> dict[str, Any]: ...
    def chat_update(self, channel: str, ts: str, text: str = ..., blocks: list[dict[str, Any]] = ...) -> dict[str, Any]: ...
    def reactions_remove(self, channel: str, timestamp: str, name: str) -> dict[str, Any]: ...
